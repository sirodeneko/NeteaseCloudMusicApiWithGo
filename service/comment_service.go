...
func (service *CommentService) Comment(c *gin.Context) map[string]interface{} {
	...
	reBody, _ := util.CreateRequest("POST", `https://music.163.com/weapi/resource/comments/`+service.T, data, options)
